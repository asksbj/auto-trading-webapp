  ...
  <li class='has-sub'><a href='#'><span>Reports</span></a>
   ...
   <li class='last'><a href='manage?userid=<%=userid%>'><span>Manage Cars</span></a></li>
				...
				<div style="text-align:center;">
			 		<table id="table-2">
			 			<tr><th>State</th><th>Make</th><th>Body Style</th><th>Drive Type</th><th>Engine</th>
			 			</tr>
			 			<c:forEach items="${info}" var="in">
			 			<tr><td>${in[0]}</td><td>${in[1]}</td><td>${in[2]}</td><td>${in[3]}</td><td>${in[4]}</td>
			 			</tr>
			 			</c:forEach>
			 		</table></div>
			 		</div>
