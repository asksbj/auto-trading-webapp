...
<style>
    ...
    <script type="text/javascript">
		...
		var x  = new Array("Sunday", "Monday", "Tuesday","Wensday","Thursday", "Friday","Saturday");
		var e = new Date();
		var day = e.getUTCDay();
		timeId.innerHTML = "Date:"+e.getYear()+"/"+(e.getMonth()+1)+"/"+e.getDate()+x[day];
	}
	</script>
	<script type="text/javascript">
...
function slideShow() {
  ...
  function transitionSlides() {
    ...
    <img src="images/show1.jpg" alt="Slide 1" width="870"  height =270 />
    <img src="images/show2.jpg" alt="Slide 2" width="870"  height =270 />
    <img src="images/show3.jpg" alt="Slide 3" width="870"  height =270 />    
    <img src="images/show4.jpg" alt="Slide 4" width="870"  height =270 />
  		</div>           
        <div id="menu">
            <ul>                                                                       
            <li class="selected"><a href="index.jsp">Homepage</a></li>
            <li><a href="about.jsp">About</a></li>
            <li><a href="contact.jsp">Contact us</a></li>
            <li><a href="userprofile?userid=<%=userid%>">My Account</a></li>
